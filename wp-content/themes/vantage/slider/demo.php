	...
	<ul class="slides">
		...
		<li>
			...
			<img src="<?php echo get_template_directory_uri() ?>/slider/backgrounds/slide-1.jpg" class="ms-default-image" width="1080" height="420" alt="<?php esc_attr_e('Demo Slide', 'vantage') ?>" />
				...
				<li>
			<div class="content">
				<img src="<?php echo get_template_directory_uri() ?>/slider/backgrounds/groot.png" width="1080" height="420" alt="<?php esc_attr_e('Demo Slide', 'vantage') ?>" />
			</div>
			<img src="<?php echo get_template_directory_uri() ?>/slider/backgrounds/guardians_of_the_galaxy.jpg" class="ms-default-image" width="1080" height="420" alt="<?php esc_attr_e('Demo Slide', 'vantage') ?>" />
		</li>
